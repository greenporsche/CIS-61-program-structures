...
class ProfessorCard(Card):
    ...
    def effect(self, other_card, player, opponent):
        ...
        opp_attack = other_card.attack
        opp_defense = other_card.defense
        
        for card in player.deck.cards:
            card.attack += opp_attack
            card.defense += opp_defense

        cards = []
        for card in opponent.deck.cards:
            if not(card.attack == opp_attack or card.defense == opp_defense):
                cards.append(card)
